...
CREATE TABLE "patients" (
  ...
  ett_depth_age_calc NUMERIC(7, 4) NOT NULL,
	...
	bp_systolic_calc_bottom int2,
	bp_systolic_calc_mid int2,
	bp_systolic_calc_top int2,
	bp_systolic_actual int2,
	bp_diastolic_calc_bottom int2,
	bp_diastolic_calc_mid int2,
	bp_diastolic_calc_top int2,
	bp_diastolic_actual int2,
	map_calc_bottom int2,
	map_calc_mid int2,
	map_calc_top int2,
	map_actual int2,
	pulse_pressure_calc_bottom int2,
	pulse_pressure_calc_mid int2,
	pulse_pressure_calc_top int2,
	ns_bolus_qty int2,
